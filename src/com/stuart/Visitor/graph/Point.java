...
public class Point extends GraphObject {
	...
	//житель бабушка - принимает продавца
	@Override
	public void accept(ExportVisitor v) {
		v.exportPoint(this); //посетитель взаимодействует именно с этим жителем - бабушкой
		//бабушка принимает продавца, продавец видя бабушку продает ей сковородку
	}
